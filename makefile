VERSION=0.1.0
LOVE_VERSION=11.5
NAME=system-override-saga
ITCH_ACCOUNT=mathiasx
URL=https://github.com/mathias/system-override-saga`
AUTHOR="Matt Gauger"
DESCRIPTION="You just got home from school, but robots have taken over your town! Repair and reprogram them to survive!"
